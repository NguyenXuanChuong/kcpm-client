...
namespace Cookbook.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult FacebookLogin(string token)
        {
            ...
            string JsonResult = client.DownloadString(string.Concat("https://graph.facebook.com/me?access_token=", token, "&fields=first_name,last_name")); //để có thể lấy được first_name và class_name
            ...
            try
            {
                var json = client.DownloadString(String.Format("http://server-20.apphb.com/api/NguoiDung/Get/{0}", id));
            ...
            catch
            {
                ...
                Account account = new Account("http-cookbookg5-gear-host", "282977229251622", "q6R2Yl8mnnigLtz8t_r4y4A6yNQ");
